...
export class WorkspaceService {
  ...
  private async pickFolderNative(dialogTitle: string): Promise<string | null> {
    ...
    const command = [
      ...
      `$dialog.Title = '${dialogTitle.replace(/'/g, "''")}'`,
  ...
  async pickWorkspaceFolder(): Promise<string | null> {
    return this.pickFolderNative("Buscar carpeta");
  }

  async pickReportFolder(): Promise<string | null> {
    return this.pickFolderNative("Carpeta para reportes HTML");
  }
